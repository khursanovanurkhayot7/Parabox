...
{
    public class AddBalanceRequestCommandHandler : BaseCommandHandler
    {
        public AddBalanceRequestCommandHandler(WebSocketService webSocketService) : base(webSocketService)
        {
        }
        ...
        public override void SendCommand(Action onCommandComplete, params object[] parameters)
        {
            ...
            {
                Type = nameof(CommandRequestType.AddBalanceRequest),
            ...
            WebSocketService.SendCommand(CommandRequestType.AddBalanceRequest, commandRequestJson,
